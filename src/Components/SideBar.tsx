    ...
    return (
        <aside className="w-100 h-screen bg-gray-50  flex flex-row fixed ">
            ...
            <div className="mt-auto bg-black h-full border-t p-4 flex flex-col items-center gap-5 text-gray-600 justify-between">
                 <div>
                     <IoTelescopeSharp size={28} className="text-xl cursor-pointer hover:text-blue-500" />

                 </div>

                <div className={'flex-row  '}>
                    <IoSearch size={28} className="text-xl cursor-pointer hover:text-blue-500 my-4" />
                    <IoMdSettings size={28}  className="text-xl cursor-pointer hover:text-blue-500 my-4" />
                    <FaBell size={28} className="text-xl cursor-pointer hover:text-blue-500 my-4" />
            ...
            <div className={'flex-1 bg-gray-300'}>
                <div className="flex items-center justify-start mx-8 my-3  ">
                    ...
                    <h1 className="text-sm  tracking-wide font-bold text-gray-700"> GLOBAL</h1>
                </div>
