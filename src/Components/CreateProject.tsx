...
export default function CreateProject() {
    ...
    return (
        <main className="flex-1 bg-white min-h-screen ml-100   ">
            <div className={'px-10 py-8 w-full border-b border-gray-300 bg-white  fixed'}>
            ...
            <div className="px-10 py-4 w-full mx-66 mt-23 fixed bg-white ">
                <h1 className="text-3xl font-bold text-gray-800 mt-4">Create New Project</h1>
            ...
            <div className={'flex-1 px-10 py-8 mx-66  mt-74 z-20'}>
                <Routes>
                    ...
                    <Route path={'/Review'} element={<ReviewProject  project={project}/>}/>
                </Routes>
