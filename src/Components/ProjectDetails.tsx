        ...
        <>
            <div className="w-full my-4  border-t border-gray-100 mx-auto bg-white rounded-lg shadow-lg p-8">
                ...
                <div className="mb-6">
                    ...
                    <p className="text-sm text-gray-500 mt-1">Basic information about your monitoring project</p>
                </div>
                ...
                {keyword}
                  ...
                  ×
                    ...
                    <p className="mt-2 text-xs text-gray-500">
                        These are the main terms you want to track. Add multiple keywords separated by commas.
                    </p>
                </div>
